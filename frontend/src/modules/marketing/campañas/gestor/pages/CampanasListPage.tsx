    ...
    return (
        <div className="space-y-6">
            ...
            <header className="flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-bold text-dark">Panel de Campañas</h1>
            ...
            <Tabs
                ...
                activeValue="campaigns"
                onChange={(value) => {
                    // Navigation to other tabs (future implementation)
