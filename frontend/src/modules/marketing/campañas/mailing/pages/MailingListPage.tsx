...
export const MailingListPage: React.FC = () => {
    console.log('MailingListPage renderizado');
    ...
    const loadCampanas = async () => {
        try {
            ...
            let errorMessage = 'Error desconocido al cargar campañas';
            ...
            if (error instanceof Error) {
                ...
                } else if (errObj.originalError?.message) {
                    errorMessage = errObj.originalError.message;
        ...
        return (
            <div className="flex items-center justify-center h-96">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 mt-4">Cargando campañas de mailing...</p>
                </div>
            </div>
        );
    }
