...
import { CampanaMailing, ActualizarContenidoRequest } from '../types/mailing.types';
...
export const MailingEditorPage: React.FC = () => {
    ...
    const handleMarkAsReady = async () => {
        try {
            ...
            alert('Campaña marcada como lista');
            navigate('/emailing');
        } catch (err: any) {
        ...
        <div className="space-y-6">
            ...
            <header className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Edita el contenido de tu correo</p>
                </div>
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        disabled={isSaving}
                        className="px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition disabled:opacity-50 font-medium"
                    >
